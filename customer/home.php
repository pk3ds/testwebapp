		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
		  ...
		  <div class="carousel-inner">
			<div class="item active">
			  <img src="../file_store/announcement/banner1.jpg" alt="Los Angeles">
			</div>

			<div class="item">
			  <img src="../file_store/announcement/banner2.jpg" alt="Chicago">
			</div>

			<div class="item">
			  <img src="../file_store/announcement/banner3.jpg" alt="New York">
			</div>
		  </div>
